...
permalink: /man_jason/
section: "man jason_"
seoTitle: "About Jason Hill | Cyber Security & OSINT"
description: "About Jason Hill, a New Zealand cyber security practitioner with a background in security operations and a particular interest in OSINT and digital investigations."
---
...
<iframe src="https://www.youtube-nocookie.com/embed/IzSDK3CFIyM" title="YouTube video player" loading="lazy" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
...
**LinkedIn**
[Jason Hill]({{ site.linkedin }})

**Email**
[{{ site.email }}](mailto:{{ site.email }})

**Other places**
[@{{ site.twitter }}](https://twitter.com/{{ site.twitter }}) · [GitHub](https://github.com/{{ site.github }})
